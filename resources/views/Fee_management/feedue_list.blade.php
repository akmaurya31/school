...
<div class="akform_holder ">
  <div class="row">
    <div class="col-md-12">
      ...
      <h1 class="custom-font"><i class="fa fa-money"></i><strong>Due</strong> Fee Search</h1>
      <ul class="controls">
          <li>
        ...
        <form role="form" class="box">
          <div class="row">
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="selectSel">List Upto Month</label>
              <select class="form-control ak_select2" name="selectSel" required> 
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="semSel">Select Class</label>
            ...
            <div class="submit-holder">
              ...
              <div class="col-sm-12"> 
              <div>
                <button type="submit" data-value="Searching..." class="btn btn-blue"><i class="fa fa-search"></i>Find</button>
              </div>
              </div> 
              </div>
              </div>
    ...
    <div class="col-md-12">
      ...
      <strong>Due</strong> Fee Lists</h1>
      </div>
      <!-- /tile header -->
        <!-- tile body-->
