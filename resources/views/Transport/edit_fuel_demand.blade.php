...
<div class="akform_holder ">
  <div class="row">
    <div class="col-md-12">
      ...
      <h1 class="custom-font"><i class="fa fa-car"></i><strong>Edit</strong> Fuel Demand</h1>
      <ul class="controls">
          <li>
      ...
      <form role="form" method="post" action="{{route('admin.update_fuel_demand',$editdetail->id)}}" class="box">
        {{ csrf_field() }}
          <div class="row">
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              ...
              <option>{{$editdetail->vehicle_type}}</option>
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="fuelTank">Fuel in tank</label>
                <select class="form-control ak_select2" name="fuelTank" required> 
                    <option>{{$editdetail->tank_fuel}}</option>
                    <option>5</option> 
                    <option>10</option> 
                    <option>15</option> 
                </select>  
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="qtyDemand">Quantity Demanded</label>
                <select class="form-control ak_select2" name="qtyDemand" required> 
                    <option>{{$editdetail->qty_demanded}}</option>
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              ...
              <input type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" value="{{$editdetail->cost_ltr}}" class="form-control" name="fCostLt" id="fCostLt" placeholder=" Ex: 75">    
            </div>
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="totCOst">Total cost</label>
              <input type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" value="{{$editdetail->total_cost}}" class="form-control" name="totCOst" id="totCOst" placeholder=" Ex: fuel cost * demand">  
            </div>
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="aprstatus">Approval Status</label>
                <select class="form-control ak_select2" name="aprstatus" required> 
                    <option>{{$editdetail->approval_status}}</option>
            ...
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              ...
              <input type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" class="form-control" value="{{$editdetail->fuel_consumed}}" name="fuelConsumed" id="fuelConsumed" placeholder=" Ex: =Km*Avg">  
            </div>
           
            <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
              <label for="remarksTxt">Remarks</label>
              <textarea class="form-control" name="remarksTxt" id="remarksTxt" value="{{$editdetail->remarks}}" cols="30" rows="3"></textarea>
            </div>
          </div>
