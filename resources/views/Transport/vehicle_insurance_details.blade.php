...
<li>
<a href="javascript:void(0)">Vehicle Insurance Details</a>
</li>
</ul>
...
@endif   --}}
    ...
    <h1 class="custom-font"><i class="fa fa-file-text"></i><strong>Create</strong> a detail</h1>
    <ul class="controls">
        <li>
    ...
    <div class="tile-body collapse">
      <form role="form"  method="post" action="{{route('admin.add_insurance_details')}}" class="box">
             {{ csrf_field() }}
        <div class="row">
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <input type="text" class="form-control" name="insurance_company" id="insurance_company" placeholder="Company Name">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="insureDate">Insureance Date</label>
            <div class='input-group datepicker ' data-format="L">
              <input type='text' id="insurance_date" autocomplete="off" name="insurance_date" class="form-control" required />
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <div class='input-group datepicker ' data-format="L">
              <input type='text' id="insurance_from" autocomplete="off" name="insurance_from" class="form-control" required />
              <span class="input-group-addon">
                <span class="fa fa-calendar"></span>
              </span>
            </div>
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <div class='input-group datepicker ' data-format="L">
              <input type='text' id="insurance_to" autocomplete="off" name="insurance_to" class="form-control" required />
              <span class="input-group-addon">
                <span class="fa fa-calendar"></span>
              </span>
            </div>  
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <input type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" class="form-control" name="insurance_period" id="insurance_period" placeholder="In years(in month)">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="insureAmt">Insureance Amount</label>
            <input type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" class="form-control" name="insurance_amount" id="insurance_amount" placeholder="eg:1800">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="vehicleNo">Policy Number</label>
            <input type="text" class="form-control" name="policy_no" id="policy_no" placeholder="Eg:AB12345/2768/89">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <input type="text" class="form-control" name="no_claim_bonus" id="no_claim_bonus" placeholder="">  
          </div>
        </div>
  ...
  <div class="col-md-12">
    ...
    <strong>Insurance</strong> List</h1>
    </div>
    <!-- /tile header -->
      <!-- tile body-->
       ...
       <table class="table table-bordered table-responsive mb-0 data_tbl--feature">
        <thead>
          <tr>
            ...
            <th class="stl_th4">Insurance Company Name</th>
            <th class="stl_th5">Insured Amount</th>
            <th class="stl_th6">Insured Date</th>
            <th class="stl_th7 action_icons_th">Actions</th>
            <th class="stl_th8">Status</th>
          </tr>
        </thead>
        <tbody>
            @foreach($vehicleinsurance as $key=>$val)
              <tr>
                <td></td>
                <td>{{++$key}}</td>
                ...
                <td>{{$val->insurance_date}}</td>
                <td>
                  <a class="btn badge badge-warning" href="{{route('admin.edit_insurance_details',$val->id)}}"  data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                  <button class="btn badge badge-warning"  onclick="return view_insurance_details({{ $val->id}});" data-toggle="tooltip" title="View"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></button>
                  <button class="btn badge badge-warning"  onclick="return delete_insurance({{$val->id}});" data-toggle="tooltip" title="Delete"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>
                </td>
                 <td> <a href="javascript:void(0);" onclick="return insurance_status({{ $val->id}});">@if($val->status == 1)<span class="status badge badge-success">Active</span>@else <span class="status badge badge-danger">Inactive</span>@endif</a></td>
              </tr>
            @endforeach
        </tbody>
      </table>
        ...
        <div class="quickvie-holder">             
              <div class="quick_info">
                  <ul>
                      ...
                      <li class="qi-item id-2"><b>Insure From:</b> <span id="insureFrom_qv">22 Aug 2020</span></li>
                      <li class="qi-item id-3"><b>Insure To:</b> <span id="insureTo_qv">21 Aug 2021</span></li>
                       <li class="qi-item id-2"><b>Insurance Company:</b> <span id="insurecompany_qv">22 Aug 2020</span></li>
                        <li class="qi-item id-2"><b>Insurance Amount:</b> <span id="insureamount_qv">22 Aug 2020</span></li>
                         <li class="qi-item id-2"><b>Insurance Period:</b> <span id="insureperiod">22 Aug 2020</span></li>
                      <li class="qi-item id-4"><b>Policy Number:</b> <span id="policyNo_qv">ABCD/2134/8796</span></li>
                      <li class="qi-item id-5"><b>Type of insurance:</b> <span id="typeInsure_qv">First</span></li>
                      <li class="qi-item id-6"><b>No claim bonus:</b> <span id="bonusClaim_qv">2000</span></li>
                  </ul>
              </div>
          </div>
      </div>
...
function delete_insurance(i){
        ...
        if(confirm)
        {
            ...
            $.ajax({                        
                ...
                url: '{{ route("delete_insurance_details") }}',                      
                ...
                success: function (argument) {  
                  swal('success','This Vehicle insurence deleted successfully','success').then((value)=>{
                          location.reload();
                            });
    ...
    function view_insurance_details(i){
	    	$.ajax({                        
					url: '{{ route("admin.show_insurance_details") }}',                      
					type: 'GET',                       
					data: {id:i},      
					dataType: 'json',                       
					success: function (data) { 
					    ...
					    $("#insureFrom_qv").html(data.data['insurance_from']);
					    $("#insureTo_qv").html(data.data['insurance_to']);
					    $("#insurecompany_qv").html(data.data['insurance_company']);
					    $("#insureamount_qv").html(data.data['insurance_amount']);
					    $("#insureperiod").html(data.data['insurance_period']);
					    $("#policyNo_qv").html(data.data['policy_no']);
					    $("#typeInsure_qv").html(data.data['insurance_type']);
					    $("#bonusClaim_qv").html(data.data['no_claim_bonus']);
