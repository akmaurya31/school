...
<li>
<a href="javascript:void(0)">Vehicle Permit</a>
</li>
</ul>
...
--}}
    ...
    <strong>Permit</strong> Details List</h1>
    ...
    <div class="table_ws_nowrap">
       <table class="table table-bordered table-responsive mb-0 data_tbl--feature">
        ...
        <tbody>
            @foreach($vehiclepermit as $key=>$val)
              <tr>
                <td></td>
                <td>{{++$key}}</td>
                ...
                <td>
                  ...
                  <button class="btn badge badge-warning" onclick="return delete_permit({{ $val->id}});" data-toggle="tooltip" title="Delete"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>
                </td>
           <td> <a href="javascript:void(0);" onclick=" permit_status({{ $val->id}});">@if($val->status == 1)<span class="status badge badge-success">Active</span>@else <span class="status badge badge-danger">Inactive</span>@endif</a></td>
              </tr>
          @endforeach
        </tbody>
      </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="ak_tile_subhead"> <h2> Create Vehicle Permit </h2></div>
      </div>
     <form role="form"  method="post" action="{{route('admin.add_permit_details')}}" class="box">
           {{ csrf_field() }}
        <div class="modal-body row">
          ...
          <div class="form-group col-sm-6 col-xs-12">
            <label for="vehicleNo">Permit Number </label>
            <input class="form-control" type="text" name="permit_no" id="permit_no" placeholder="Eg: DL 1234" required>
          </div>
          <div class="form-group col-sm-6 col-xs-12">
          ...
          <div class="form-group col-sm-6 col-xs-12">
            ...
            <div class='input-group  ' data-format="L">
              <input type='text' id="to_date" autocomplete="off"  name="to_date" class="form-control" required />
              <span class="input-group-addon">
                <span class="fa fa-calendar"></span>
              </span>
            </div>
...
<div id="formModal2" class="modal fade">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-header">
    <h4> Update Permit Details   <button type="button" class="close" data-dismiss="modal">
          <i class="fa fa-times" aria-hidden="true"></i>
        </button></h4>
      <form role="form"  method="post" action="{{route('admin.update_permit_details')}}" class="box">
           {{ csrf_field() }}
        <div class="modal-body row">
          <div class="form-group col-sm-6 col-xs-12">
            <label for="vehicleNo">Vehicle Number</label>
          ...
          <div class="form-group col-sm-6 col-xs-12">
            <label for="vehicleNo">Permit Number </label>
            <input class="form-control" type="number"  onkeydown="limit(this,12);" onkeyup="limit(this,12);" name="permit_no" id="permit_no" placeholder="Eg: DL 1234" required>
          </div>
          <div class="form-group col-sm-6 col-xs-12">
            <label for="fromDate">From Date</label>
            <div class='input-group datepicker ' data-format="L">
              <input type='text' id="from_dates" autocomplete="off" name="from_date" class="form-control" required />
              <span class="input-group-addon">
                <span class="fa fa-calendar"></span>
              </span>
            </div>
          ...
          <div class="form-group col-sm-6 col-xs-12">
            <label for="toDate">To Date</label>
            <div class='input-group  ' data-format="L">
              <input type='text' id="to_dates" name="to_date" class="form-control" required />
              <span class="input-group-addon">
                <span class="fa fa-calendar"></span>
              </span>
            </div>
        ...
        <div class="quickvie-holder">             
              <div class="quick_info">
                  <ul>
                      ...
                      <li class="qi-item id-1"><b>Permit No:</b> <span id="veh_perno">DL 04 JC 6789</span></li>
    ...
    function delete_permit(i){
        ...
        if(confirm)
        {
            ...
            $.ajax({                        
                ...
                url: '{{ route("delete_permit_details") }}',                      
...
function view_details(i){
	    	$.ajax({                        
					url: '{{ route("admin.show_permit_details")}}',                      
					type: 'GET',                       
					data: {id:i},      
					dataType: 'json',                       
					success: function (data) { 
					    ...
					    $("#veh_perno").html(data.data['permit_no']);
...
function edit_details(i){
	    	$.ajax({                        
					url: '{{ route("admin.edit_permit_details") }}',                      
					type: 'GET',                       
					data: {id:i},      
					dataType: 'json',                       
					success: function (data) {    
            ...
            $("#formModal2 #vehicle_name").empty();
					    ...
					    $("#formModal2 #permit_no").val(data.data['permit_no']);
