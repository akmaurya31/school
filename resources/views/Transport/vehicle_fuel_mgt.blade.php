  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile-body collapse">
        <form role="form" class="box"  method="post" action="{{route('admin.add_fuel_mgt')}}">
        {{ csrf_field() }}
          <div class="row">
        ...
        <div class="quickvie-holder">             
              <div class="quick_info">
                  <ul>
                      ...
                      <li class="qi-item id-3"><b>Fuel Type:</b> <span id="regOn_qv"></span></li>
                      <li class="qi-item id-4"><b>Tankcapacity</b> <span id="typescript_qv"></span></li>
                      <li class="qi-item id-5"><b>liter:</b> <span id="ownCo_qv"></span></li>
                      <li class="qi-item id-6"><b>route_no:</b> <span id="taxNo_qv"></span></li>
                      <li class="qi-item id-7"><b>Route Distance:</b> <span id="taxAmt_qv"></span></li>
                      <li class="qi-item id-8"><b>last Meter Reading:</b> <span id="taxPayon_qv"></span></li>
                      <li class="qi-item id-9"><b>Current Meter Reading:</b> <span id="taxPayto_qv"></span></li>
                      <li class="qi-item id-10"><b>Total km:</b> <span id="TaxType_qv"></span></li>
                      <li class="qi-item id-11"><b>Fuel Consumed:</b> <span id="insuranceCo_qv"></span></li>
                      <li class="qi-item id-12"><b>Tank Fuel:</b> <span id="insuredAmt_qv"></span></li>
          ...
          <tbody>
            @foreach($fueldetail as $key=>$val)
              <tr>
                ...
                <td>{{$val->route_no}}</td>
                <td>{{$val->route_dis}}</td>
                <td>{{$val->last_meter_reading}}</td>
                <td>{{$val->current_meter_reading}}</td>
                <td>{{$val->total_km}}</td>
                <td>{{$val->fuel_consumed}}</td>
                <td>{{$val->tank_fuel}}</td>

                <td>
                <a class="btn badge badge-warning" href="{{route('admin.edit_fuel_mgt',$val->id)}}" title="Edit"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                  ...
                  <button class="btn badge badge-warning" onclick="return delete_fuel({{ $val->id}});" data-toggle="tooltip" title="Delete"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>
                </td>
           <td> <a href="javascript:void(0);" onclick="return fuel_mgt_status({{ $val->id}});">@if($val->status == 1)<span class="status badge badge-success">Active</span>@else <span class="status badge badge-danger">Inactive</span>@endif</a></td>
              </tr>
          @endforeach
        </tbody>
        </table>
...
function view_details(i){
	    	$.ajax({                        
					...
					success: function (data) { 
					    ...
					    $("#regOn_qv").html(data.data['fuel_type']);
					    $("#typescript_qv").html(data.data['tankcapacity']);
					    $("#ownCo_qv").html(data.data['liter']);
					    $("#taxNo_qv").html(data.data['route_no']);
					    $("#taxAmt_qv").html(data.data['route_dis']);
					    $("#taxPayon_qv").html(data.data['last_meter_reading']);
					    $("#taxPayto_qv").html(data.data['current_meter_reading']);
					    $("#TaxType_qv").html(data.data['total_km']);
					    $("#insuranceCo_qv").html(data.data['fuel_consumed']);
					    $("#insuredAmt_qv").html(data.data['tank_fuel']);
