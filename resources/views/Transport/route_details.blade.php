...
<div class="row">
  <div class="col-md-12">
    ...
    <h1 class="custom-font"><i class="fa fa-map"></i><strong>Create route</strong></h1>
    <ul class="controls">
        <li>
    ...
    <div class="tile-body collapse">
      <form role="form" class="box" action="{{route('admin.add_route_details')}}" method="post">
      {{ csrf_field() }}
        ...
        <div class="row">
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="vehicle_no" id="vehicle_no" required>
              ...
              @foreach($vehicle as $key=>$vala)
                 <option value="{{$vala->registerNo}}">{{$vala->registerNo}}</option>
             @endforeach
            </select>
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="routeName">Route Name</label>
            <input type="text" class="form-control" name="route_name" id="route_name" onkeypress="return /^[a-zA-Z\s]+$/i.test(event.key)" placeholder="Route Name">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="routCode">Route Code</label>
            <input type="text" class="form-control" name="route_code" id="route_code" placeholder="Route Code">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="routInfo">Route Information</label>
            <input type="text" class="form-control" name="route_information" id="route_information" placeholder="Route Code">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <input type="text" class="form-control" name="starting_point" id="starting_point" placeholder="Starting Point">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="routEnd">Route Ending Point</label>
            <input type="text" class="form-control" name="ending_point" id="ending_point" placeholder="Ending Point">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="distance">Apporximate Distance</label>
            <input type="number"  onkeydown="limit(this,5);" onkeyup="limit(this,5);" class="form-control" name="distance" id="distance" placeholder="in KM">  
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="fare">Fare</label>
            <input type="text" class="form-control" name="fared" id="fared" placeholder="Priority">  
          </div>
        </div>  
       ...
       <table class="table table-bordered table-responsive mb-0 data_tbl--feature">
        <thead>
          <tr>
            ...
            <th class="stl_th4">Route Code</th>
            <th class="stl_th5">Starting Place</th>
            <th class="stl_th6">Ending Place</th>
            <th class="stl_th6">Apporximate Distance</th>
            <th class="stl_th7 action_icons_th">Actions</th>
            <th class="stl_th8">Status</th>
          </tr>
        </thead>
        <tbody>
          @foreach($vehicleroute as $key=>$val)
            <tr>
              <td></td>
              <td>{{$key+1}}</td>
              ...
              <td>
                <a  href="{{route('admin.edit_route_details',$val->id)}}" class="btn badge badge-warning" data-toggle="tooltip"  title="Edit"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                ...
                <button class="btn badge badge-warning" onclick="return delete_route_details({{$val->id}});" data-toggle="tooltip" title="Delete"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>
              </td>
        ...
        <div class="quickvie-holder">             
              <div class="quick_info">
                  ...
                  <ul>
                      ...
                      <li class="qi-item id-3"><b>Route Name:</b> <span id="routeName_qv">Option 1</span></li>
                      <li class="qi-item id-4"><b>Route Code Description:</b> <span id="routecode_qv">lorem ipsum is a dummy text to fill html</span></li>
                      <li class="qi-item id-5"><b>Route Information:</b> <span id="info_qv">20/22 Kidwai Nagar</span></li>
                      <li class="qi-item id-6"><b>Select Vehicle to the route:</b> <span id="vehiclename_qv">Pune</span></li>
                      <li class="qi-item id-7"><b>Route Starting Point:</b> <span id="spoint_qv">Tathawade</span></li>
                      <li class="qi-item id-8"><b>Route Ending Point:</b> <span id="epoint_qv">208001</span></li>
                      <li class="qi-item id-9"><b>Apporximate Distance:</b> <span id="distance_qv">+91532254668</span></li>
                      <li class="qi-item id-10"><b>Fare:</b> <span id="fare_qv">djmerrit45@gmail.com</span></li>
