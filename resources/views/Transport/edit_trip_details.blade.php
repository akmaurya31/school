...
@endif  --}}
    ...
    <!-- tile body -->
    <div class="tile-body ">
      <form role="form" method="post" action="{{route('admin.update_trip_details',$edittripdetail->id)}}" class="box">
      {{ csrf_field() }}
      <div class="row">
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="vehicleMode" id="vehicleMode" required>
              <option>{{$edittripdetail->vehicleMode}}</option>
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="vehicleNo" id="vehicle_no" required>
              <option value="">{{$edittripdetail->vehicleNo}}</option>
          ...
          <label for="routeSel">Route</label>
            <select class="form-control ak_select2" name="routeSel" id="routeSel" required>
              <option>{{$edittripdetail->routeSel}}</option>
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="vehicleSel" id="vehicle_name" required>
              <option>{{$edittripdetail->vehicleSel}}</option>
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="driverSel" id="vehicle_name" required>
              <option>{{$edittripdetail->driverSel}}</option>
          ...
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            ...
            <select class="form-control ak_select2" name="timeSel" id="timeSel" required>
              <option value="">{{$edittripdetail->timeSel}}</option>
              <option  @if($edittripdetail->timeSel == "Morning") selected @endif value="Morning" >Morning </option>
              <option @if($edittripdetail->timeSel == "Evening") selected @endif value="Evening">Evening</option>
            </select>
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="fromTime">From Time</label>
            <input class="form-control" type="time" name="fromTime" value="{{$edittripdetail->fromTime}}" id="fromTime" required>   
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="toTime">To Time</label>
            <input class="form-control" type="time" name="toTime" id="toTime"  value="{{$edittripdetail->toTime}}" required>   
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="startingPlace">Starting Place</label>
            <input class="form-control" type="text" name="startingPlace"  value="{{$edittripdetail->startingPlace}}" id="startingPlace" required>   
          </div>
          <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <label for="endingPlace">Ending Place</label>
            <input class="form-control" type="text" name="endingPlace"  value="{{$edittripdetail->endingPlace}}" id="endingPlace" required>   
          </div>
        </div>
