...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form role="form" action="{{ route('parent.parent-filter') }}" method='post'>
        {{ @csrf_field() }}
        <div class="row">
  ...
  <tr>
    ...
    <td>
        ...
        <div class="ak_actionbtns">
            ...
            <a href="#" onclick="return deactive_parents({{$key->s_father_adhar}})"  class="action_icons del" title='Deactive'><i class="fa fa-power-off"></i></a>
            ...
            <a href="#" onclick="return view_model({{$key->s_father_adhar}})" class="action_icons del" title="Reset Password"><i class="fas fa-lock"></i></a>
	...
	function reset_password()
	{
	    if(confirm('are you sure')){
    	    ...
    	    if(password == '' || confirm_pass == ''){
        	    ...
        	    if(password == confirm_pass){
            	    $.ajax({                        
            			url: '{{ url("admin/parent/reset_password") }}',                      
            			type: 'GET',                       
