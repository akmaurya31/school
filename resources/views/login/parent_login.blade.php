...
<title>School ERP - Login Parents</title>
            ...
            <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                ...
                <div class="sign-area">
                    ...
                    <div class="sign-hader">
                       ...
                       <h2 class=" header-text"><img src="{{ asset('assets/images/loginicon_parents.png') }}" width="100" class="login-icon"/> Log In <span> Parents </span></h2>
                   ...
                   <form name="form" class="form-validation" novalidate="" method='post' action="{{ route('login.parent-login-request') }}">
