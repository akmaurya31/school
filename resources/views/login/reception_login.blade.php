                ...
                <div
                    ...
                    <div class="sign-area">
                        <div class="sign-hader">
                            <h2 class=" header-text"><img src="{{ asset('assets/images/receptionist.svg')}}" width="100" 
                                    class="login-icon" />Log In <span>Receptionist</span></h2>
                            ...
                            action="reception-login-request">{{ csrf_field()}} <div
                                class="form-group ">
