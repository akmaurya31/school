...
<h2 class=" header-text"><img src="{{ asset('assets/images/accountant.svg')}}" width="100" class="login-icon" />Log In <span>Accountant </span></h2>
</div>
...
<form name="form" class="form-validation" novalidate="" method='post' action="accounts-login-request">
{{ csrf_field() }}
