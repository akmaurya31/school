...
<div class="col-md-12">
        ...
        <h1 class="custom-font"><i class="fa fa-pencil-square-o"></i> <strong>Select1 </strong>Ground</h1>
        ...
        <div class="row">
            <div class="form-group col-md-3">
                <label for="cls">Departments</label>
...
<h1 class="custom-font"><i class="fas fa5-users"></i> <strong>Staff </strong>List</h1>
