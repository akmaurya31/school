                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="catname">Session *</label>
                                            ...
                                            <input type="text" class="form-control" id="catname" name='session' value="{{ old('session') }}" placeholder='Ex.2020-2021'>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="catname">Class No *</label>
                                            ...
                                            <input type="text" class="form-control" id="catname" name='classNo'value="{{ old('classNo') }}" >
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="catname">Section *</label>
                                            ...
                                            <input type="text" class="form-control" id="catname" name='section' value="{{ old('section') }} ">
            ...
            <div class="col-md-6">
               ...
               <section class="tile">
                ...
                <div class="tile-body ak_table ak_table2 clas-listtable">
                    ...
                    <a href="{{route('classes.edit',$key)}}" class="action_icons edt" ><i class="fa fa-pencil"></i></a> 
...

     {
...

        {
            ...
            $.ajax({                        
                ...
                url: '{{ route("classes.delete-class")}}',                      
