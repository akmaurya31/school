...
<div class="dropdown-menu animated littleFadeInRight" role="menu">
    ...
    <div class="u-text">
        <p class="text-muted">Loged in as : Student</p>
        <h4>User Name</h4>
    ...
    <li role="separator" class="divider"></li>
    <li><a href="student-logout"><i class="fas fa5-sign-out-alt"></i> Logout</a></li>
    </ul>
    </div>
<!--
<ul class="dropdown-menu animated littleFadeInRight" role="menu">
...
<li class="@if(isset($dash)) {{ $dash }} @endif "><a href="{{ route('student-dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
